...
@section('title', 'Add Next of Kin — ' . $patient->full_name)
...
<div class="max-w-2xl mx-auto px-6 py-8">
    ...
    <div class="mb-7 anim-fade-up">
        ...
        <h1 class="text-3xl font-bold text-white tracking-tight">Add Next of Kin</h1>
    ...
    {{-- ── Form ── --}}
    <form action="{{ route('patients.next_of_kins.store', $patient->patient_number) }}"
          method="POST"
          id="nokForm">
        @csrf
            ...
            <div class="px-6 py-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="flex flex-col gap-1.5">
                    <label for="full_name"
                        ...
                        Full Name <span class="text-wm-cyan">*</span>
                    </label>
                    <input
                        type="text"
                        id="full_name"
                ...
                <div class="flex flex-col gap-1.5">
                    <label for="relationship"
                           class="text-xs font-semibold tracking-wide uppercase text-slate-400">
                        Relationship <span class="text-wm-cyan">*</span>
                    </label>
                    <input
                        type="text"
                        id="relationship"
