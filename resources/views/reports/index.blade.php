...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('reports.create') }}" class="px-4 py-2 bg-[#1f3b5c] text-white rounded hover:bg-[#2a4d7a]">
            Report New Incident
        </a>
    </div>
            ...
            @forelse($incidents as $incident)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <form action="{{ route('reports.destroy', $incident->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this incident report?');" class="inline-block">
                            @csrf
                            @method('DELETE')
