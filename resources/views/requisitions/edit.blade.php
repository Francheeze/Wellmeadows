        ...
        <div class="bg-[#032d4f] border border-[#CCECEE]/15 rounded-2xl overflow-hidden shadow-2xl mb-5 fade-in">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-3" id="drugItemsList">
                    @forelse ($requisition->requisitionDrugItems as $drug)
                ...
                <div id="drugEmptyState" class="text-center py-8 border-2 border-dashed border-[#CCECEE]/10 rounded-xl text-[#CCECEE]/30 text-sm {{ $requisition->requisitionDrugItems->isNotEmpty() ? 'hidden' : '' }}">
        ...
        <div class="bg-[#032d4f] border border-[#CCECEE]/15 rounded-2xl overflow-hidden shadow-2xl fade-in">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-3" id="supplyItemsList">
                    @forelse ($requisition->requisitionSupplyItems as $item)
                ...
                <div id="supplyEmptyState" class="text-center py-8 border-2 border-dashed border-[#CCECEE]/10 rounded-xl text-[#CCECEE]/30 text-sm {{ $requisition->requisitionSupplyItems->isNotEmpty() ? 'hidden' : '' }}">
                    <svg class="w-8 h-8 mx-auto mb-2 opacity-30" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/>
                    </svg>
...
<script>
    ...
    let drugIndex   = {{ $requisition->requisitionDrugItems->count() }};
    let supplyIndex = {{ $requisition->requisitionSupplyItems->count() }};
