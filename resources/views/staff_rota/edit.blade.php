        ...
        <form action="{{ route('staff-rota.update', $staffRota->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="shift" required>
                    <option value="Early" {{ $staffRota->shift == 'Early' ? 'selected' : '' }}>Early</option>
                    <option value="Late"  {{ $staffRota->shift == 'Late'  ? 'selected' : '' }}>Late</option>
                    <option value="Night" {{ $staffRota->shift == 'Night' ? 'selected' : '' }}>Night</option>
                </select>
            </div>
