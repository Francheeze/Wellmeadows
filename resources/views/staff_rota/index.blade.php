...
/* EXACT MATCH TO YOUR WARD INDEX METRIC CARDS */
.attr-card {
    background: #03416E;
    border-radius: 12px;
    padding: 18px;
...
/* EXACT MATCH TO YOUR TABLE CARD BACKGROUND */
.table-card {
    background: #032d4f;
    border-radius: 12px;
...
/* COMPATIBLE SHIFT DESIGN BADGES */
.shift-badge {
...
.shift-Early { background: rgba(59,130,246,0.15); color: #93c5fd; border: 1px solid rgba(59,130,246,0.25); }
.shift-Late  { background: rgba(139,92,246,0.15); color: #c4b5fd; border: 1px solid rgba(139,92,246,0.25); }
.shift-Night { background: rgba(204,236,238,0.08); color: #CCECEE; border: 1px solid rgba(204,236,238,0.15); }

.ward-badge {
    display: inline-block;
    background: rgba(204,236,238,0.06);
    color: #CCECEE;
    border-radius: 6px;
        ...
        <table class="data-table">
            ...
            <tbody id="rota-tbody">
                ...
                <tr class="rota-row" data-ward="{{ $rota->ward_number }}" data-shift="{{ $rota->shift }}">
                    ...
                    <td style="color: rgba(204,236,238,0.6);">{{ \Carbon\Carbon::parse($rota->week_start_date ?? $rota->weekstartdate)->format('d-M-y') }}</td>
                    <td>
