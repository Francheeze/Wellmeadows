    ...
    <div class="bg-wm-card border border-wm-navy/60 rounded-2xl overflow-hidden
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-wm-navy/30">
                    ...
                    <tr class="row-hover transition-colors duration-150">
                        ...
                        {{-- Address --}}
                        <td class="px-5 py-4">
                            <p class="text-slate-400 truncate max-w-[220px]" title="{{ $doctor->address }}">
                                {{ $doctor->address }}
                            </p>
                        </td>
                        ...
                        {{-- Telephone --}}
                        <td class="px-5 py-4 whitespace-nowrap">
                            <p class="text-slate-300 tabular-nums">{{ $doctor->telephone_number }}</p>
                        </td>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="text-center py-16 px-4">
                                ...
                                @if (request()->filled('search'))
                                    <p class="text-slate-500 text-sm mb-1">No doctors match your search criteria.</p>
                                    <a href="{{ route('local_doctors.index') }}"
                                       class="text-wm-cyan text-sm hover:text-wm-cyan-dim transition-colors">
                                        Clear filters
                                    </a>
                                @else
                                    <p class="text-slate-500 text-sm mb-4">No local doctors registered yet.</p>
                                    <a href="{{ route('local_doctors.create') }}"
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-t border-wm-navy/60">
            <span class="text-xs text-slate-500">
                ...
                of {{ number_format($doctors->total()) }} doctors
            </span>
